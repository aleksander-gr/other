...
(function (arrOfTasks) {
    ...
    function listItemTemplate({
      ...
      deleteBtn.classList.add("btn", "btn-danger", "ml-auto", 'btn-delete');
    ...
    function deleteTask(id) {
      const isConfrim = confirm('Вы действительно хотите удалить ? ')
      if (isConfrim) {
        console.log(true);
      } else {
        console.log(false);
  ...
  function onDeleteHandler({}) {
    if (target.classList.containers('btn-delete')) {
